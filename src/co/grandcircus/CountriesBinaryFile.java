	...
	public static void createFile() {
		...
		if (Files.notExists(path)) {
			try {
				...
				china.setName("China");
				Long chinaPop = (long)138000000;
				china.setPopulation(chinaPop);
				Long uSAPop = (long)375000000;
				uSA.setPopulation(uSAPop);
				
				CountriesBinaryFile.writeToFile(china);
				CountriesBinaryFile.writeToFile(uSA);
